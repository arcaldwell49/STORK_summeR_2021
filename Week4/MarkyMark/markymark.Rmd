...
The output you should have at the end of class should be close to what I have below!
...
Here is a good articlet to read on ggplot2! You may run into errors if you want to include emojis AND are knitting a pdf.
